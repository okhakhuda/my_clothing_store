...
const DeliverySelection = ({ onDeliverySelected }) => {
  ...
  }, [selectedDepartment, selectedProvider, selectedRegion, selectedCity, regions, cities, departments, onDeliverySelected])
        ...
        {!isLoading && !error && (
          <div className={s.selectionFields}>
            <div className={s.fieldGroup}>
              <label htmlFor="region" className={s.fieldLabel}>Область</label>
            ...
            <div className={s.fieldGroup}>
              <label htmlFor="city" className={s.fieldLabel}>Місто</label>
              <div className={s.selectWrapper}>
                <select 
                  id="city"
            ...
            <div className={s.fieldGroup}>
              <label htmlFor="department" className={s.fieldLabel}>Відділення</label>
              <div className={s.selectWrapper}>
                <select 
                  id="department"
