...
import { NewImagesPreview, ExistingImagesList } from './ProductImagesFields'
    ...
    <>
      ...
      <div className={s.modal}>
        ...
        <form onSubmit={handleSubmit} className={s.form}>
          ...
          <NewImagesPreview previewImages={previewImages} onDelete={handlePreviewImageDelete} />

          <ExistingImagesList
            images={formData.productImage}
            onDelete={cloudId => handleExistingImageDelete(productData.id, cloudId)}
          />
          ...
          <fieldset className={s.fieldset}>
            ...
            <SizeSelector sizes={sizesPrev} selectedSizes={formData.sizeList || []} onToggle={handleSizeChange} />
